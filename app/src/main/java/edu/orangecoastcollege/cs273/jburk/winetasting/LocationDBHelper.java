...
class LocationDBHelper extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "WineFinder";
    private static final int DATABASE_VERSION = 1;

    //TASK: DEFINE THE FIELDS (COLUMN NAMES) FOR THE wine LOCATIONS TABLE
    ...
    public boolean importLocationsFromCSV(String csvFileName) {
        ...
        try {
            while ((line = buffer.readLine()) != null) {
                ...
                if (fields.length != 9) {
                    Log.d("wine Locations", "Skipping Bad CSV Row: " + Arrays.toString(fields));
                    continue;
                }
